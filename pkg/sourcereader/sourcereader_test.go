...
func (s *MySuite) TestFactory(c *C) {
	...
	c.Assert(reflect.TypeOf(ghSrcString), Equals, reflect.TypeOf(GetterSourceReader{}))

	// Git modules
	gitSrcString := Factory("git::https://gitlab.com/modules")
	c.Assert(reflect.TypeOf(gitSrcString), Equals, reflect.TypeOf(GetterSourceReader{}))
}
