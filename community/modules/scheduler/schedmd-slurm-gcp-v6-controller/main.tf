...
locals {
  ...
  labels = merge(var.labels, { ghpc_module = "schedmd-slurm-gcp-v6-controller" })
}
...
module "slurm_controller_instance" {
  source = "github.com/SchedMD/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_controller_instance?ref=6.1.0"
...
module "slurm_controller_template" {
  source = "github.com/SchedMD/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_instance_template?ref=6.1.0"
