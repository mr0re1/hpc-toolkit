...
module "slurm_controller_instance" {
  source = "github.com/mr0re1/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_controller_instance?ref=maintenance_periodic"
...
module "slurm_controller_template" {
  source = "github.com/mr0re1/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_instance_template?ref=maintenance_periodic"
