...
```yaml
- id: node_group
  source: community/modules/compute/schedmd-slurm-gcp-v6-node-group
  settings:
...
| Name | Description |
|------|-------------|
| <a name="output_node_groups"></a> [node\_groups](#output\_node\_groups) | Details of the node group. Typically used as input to `schedmd-slurm-gcp-v6-partition`. |
