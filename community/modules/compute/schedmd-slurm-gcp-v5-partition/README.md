...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_slurm_partition"></a> [slurm\_partition](#module\_slurm\_partition) | github.com/mr0re1/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_partition | maintenance_periodic |
