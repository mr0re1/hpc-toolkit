...
[schedmd-slurm-gcp-v6-node-group](../schedmd-slurm-gcp-v6-node-group/README.md)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_slurm_partition"></a> [slurm\_partition](#module\_slurm\_partition) | github.com/SchedMD/slurm-gcp.git//terraform/slurm_cluster/modules/slurm_partition | 6.1.0 |
