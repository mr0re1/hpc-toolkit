...
variable "nodeset" {
  description = "Define nodeset."
  # TODO: remove optional & defaults from fields, since they SHOULD be properly set by user-facing modules and not here.
  type = object({
...
variable "startup_scripts" {
  description = "List of scripts to be ran on nodeset VMs startup."
  type = list(object({
    filename = string
    content  = string
  }))
